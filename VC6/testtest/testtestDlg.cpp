// testtestDlg.cpp : implementation file
//
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CTesttestDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CTesttestDlg, CDialog)
	//{{AFX_MSG_MAP(CTesttestDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
void CTesttestDlg::OnOK() 
{
	// TODO: Add extra validation here
	DWORD dw = (DWORD)time(NULL);
	CString str;
	str.Format(_T("%d, %x"), dw, dw);
	MessageBox(str);
	CDialog::OnOK();
}
