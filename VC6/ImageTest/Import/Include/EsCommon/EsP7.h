...
u4 CALL_TYPE EsCertEncodeDn(const char* pszDn, void* pvDerDn, u4* pu4DerDnLen);
...
u4 CALL_TYPE EsCertParseSn(const void* pvDerSn, u4 u4DerSnLen, u1* pu1Sn, u4* pu4SnLen);
...
u4 CALL_TYPE EsCertConstructEx(const BlkAsymKey* pblkAsymKeyCa, const u1* pu1DerCertCa, u4 u4DerCertCaLen,
							   const BlkAsymKey* pblkAsymKey, const u1* pu1DerDn, u4 u4DerDnLen, u4 u4CertType, void* pvDerCert, u4* pu4DerCertLen);
