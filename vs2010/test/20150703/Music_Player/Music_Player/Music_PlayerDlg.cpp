...
// Music_PlayerDlg.cpp : implementation file
//
...
CMusic_PlayerDlg::CMusic_PlayerDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMusic_PlayerDlg::IDD, pParent)
{
...
// CMusic_PlayerDlg message handlers
...
void CMusic_PlayerDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
