...
BEGIN_MESSAGE_MAP(CListCtrlDemoDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_EN_CHANGE(IDC_NETADDRESS1, &CListCtrlDemoDlg::OnEnChangeNetaddress1)
END_MESSAGE_MAP()
...
void CListCtrlDemoDlg::OnEnChangeNetaddress1()
{
